...
import "./Aptis.scss";
import aptisImg from "./../../../../image/Home-aptis.png";
    ...
    return (
        <div id="aptis">
            <div className="container">
                <div className="aptis">
                    <h1 className="aptis-title">What is APTIS?</h1>
                    <div className="aptis-line"></div>
                    <div className="aptis-bg">
                        <img src={aptisImg} alt=""/>
                    </div>
                    <h2 className="aptis-h2">What Is APTIST ? A Complete Introduction</h2>
                    <p className="p-1">Introduced in 1989, IELTS, the International English Language Testing System, is an English
